...
def test_move_object():
    lista = []
    lista = add_object(1, "obiect 1", "descriere 1", 4000, "parter", lista)
    lista = add_object(2, "obiect 2", "descriere 2", 1000, "arhiva", lista)
    lista = add_object(3, "obiect 3", "descriere 3", 3510, "sala mese", lista)
...
def test_concat_str():
    obiect = creare_obiect(2, "Monitor Dell", "23.5'', HD, 148Hz", 1099, "sala conferinte")
    str = " string de test"
